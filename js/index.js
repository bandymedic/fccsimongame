...
function makeUnclickable() {
  ...
  ids.map(function(id) {
    ...
    $("#b" + id).css("cursor", "default");
    $("#b" + id).removeClass("b" + id + "_active");
  });
...
function makeClickable() {
  var ids = [0, 1, 2, 3];
  ids.map(function(id) {
    document.getElementById("b" + id).addEventListener("click", sendNumber);
    $("#b" + id).css("cursor", "pointer");
    $("#b" + id).addClass("b" + id + "_active");
  });
  document.getElementById("btn1").removeEventListener("mousedown", f1);
  document.getElementById("btn1").removeEventListener("mouseup", s1);
  document.getElementById("btn2").removeEventListener("mousedown", f2);
